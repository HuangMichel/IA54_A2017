...
import fr.utbm.ia54.TP2.hollonresearch.FoundFile;
import fr.utbm.ia54.TP2.hollonresearch.SearchRequest;
...
public class SearchManager extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info("Initialize SearchManager");
    ...
    if (_isEmpty) {
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_2.info("Empty parameters in SARL environment, we will use default parameters");
      this.xten = ".xlsx";
      this.pfile = "C:\\Users\\Michel\\Desktop\\Cours\\HX08";
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_3.info(("extension file " + this.xten));
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_4.info(("path " + this.pfile));
    } else {
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_5.info("Find parameters in SARL environment");
      Object _get = occurrence.parameters[0];
      this.xten = ((String) _get);
      Object _get_1 = occurrence.parameters[1];
      this.pfile = ((String) _get_1);
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_6.info(("extension file " + this.xten));
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_7.info(("path " + this.pfile));
    }
    ...
    final AgentTask task = _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.task("WAITING_SEARCHAGENT");
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      if (_greaterThan) {
        ...
        _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_8.error("Found SearchAgent");
        DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1 = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
        File _file = new File(this.pfile);
        SearchRequest _searchRequest = new SearchRequest(_file, this.xten);
        _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1.emit(_searchRequest);
        ...
        final Procedure1<Agent> _function_1 = (Agent it_1) -> {
          ...
          int _size_1 = _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_2.getDefaultContext().getDefaultSpace().getParticipants().size();
          ...
          if (_equals) {
            ...
            _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_9.error("I\'m alone, killMySelf");
            ...
            _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_10.info(("Still searching file endwiths " + this.xten));
          }
        };
        _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER_2.every(5000, _function_1);
        ...
        _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER_3.cancel(task);
      } else {
        Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_9 = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
        _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_9.info("Waiting SearchAgent");
      }
    };
  ...
  @SyntheticMember
  private void $behaviorUnit$FoundFile$1(final FoundFile occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    UUID _iD = this.getID();
    String _plus = ((("Found File " + occurrence.File) + " by receiver ") + _iD);
    String _plus_1 = (_plus + ", source : ");
    UUID _uUID = occurrence.getSource().getUUID();
    String _plus_2 = (_plus_1 + _uUID);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.error(_plus_2);
  }
  
  @SyntheticMember
  private void $behaviorUnit$Destroy$2(final Destroy occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.error("SearchManager go to die");
  }
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$FoundFile(final FoundFile occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$FoundFile$1(occurrence));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!Objects.equals(this.xten, other.xten)) {
      return false;
    }
    if (!Objects.equals(this.pfile, other.pfile)) {
      return false;
    }
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + Objects.hashCode(this.xten);
    result = prime * result + Objects.hashCode(this.pfile);
    return result;
  }
