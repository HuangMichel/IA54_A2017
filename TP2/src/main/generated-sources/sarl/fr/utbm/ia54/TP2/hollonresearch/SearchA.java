...
public class SearchA extends Agent {
  @SyntheticMember
  ...
  private void $behaviorUnit$SearchRequest$1(final SearchRequest occurrence) {
    ...
    if (_exists) {
      ...
      for (final java.io.File f : _listFiles) {
        {
          ...
          if (((!(fileName.startsWith(".") || fileName.startsWith(".."))) && f.isDirectory())) {
            ...
            _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawnInContext(SearchA.class, _$CAPACITY_USE$IO_SARL_CORE_INNERCONTEXTACCESS$CALLER.getInnerContext(), new Object[] { f, tension });
          } else {
            if ((fileName.startsWith(".") || fileName.startsWith(".."))) {
              ...
              if (_endsWith) {
                ...
                _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_5.info(((fileName + " endswith ") + tension));
              } else {
      ...
      final Procedure1<Agent> _function = (Agent it) -> {
        ...
        if (_equals) {
          Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_2 = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
          _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_2.info("Kill the child");
          Behaviors _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER = this.$castSkill(Behaviors.class, (this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS == null || this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS = this.$getSkill(Behaviors.class)) : this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS);
          Stop _stop = new Stop();
  ...
  @SyntheticMember
  public SearchA(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public SearchA(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public SearchA(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
