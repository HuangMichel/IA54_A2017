...
import fr.utbm.ia54.TP2.hollonresearch.SearchA;
...
public class SearchM extends Agent {
  private String xten;
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    if (_isEmpty) {
      ...
      this.xten = ".md";
      this.pfile = "C:\\Users\\Michel\\Desktop\\IA54_A2017";
    ...
    if (_equals) {
      ...
      _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(SearchA.class);
    }
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      int _size_1 = _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1.getDefaultSpace().getParticipants().size();
      ...
      if (_greaterThan) {
        ...
        _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_8.info("Found SearchAgent");
        ...
        _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_2.emit(_searchRequest);
        ...
        final Procedure1<Agent> _function_1 = (Agent it_1) -> {
          ...
          int _size_2 = _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_3.getDefaultContext().getDefaultSpace().getParticipants().size();
          ...
          if (_equals_1) {
            ...
            _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_9.info("I\'m alone, killMySelf");
  ...
  private void $behaviorUnit$Destroy$2(final Destroy occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("SearchManager go to die");
  }
  ...
  @SyntheticMember
  public SearchM(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public SearchM(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public SearchM(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
